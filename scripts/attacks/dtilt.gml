...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE_FLIPPER, 4); //Horz-Inwards
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 120);
...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE_FLIPPER, 10); //Movement direction
