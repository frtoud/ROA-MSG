...
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, 66);
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, hfx_error_b);
...
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_SPRITE, sprite_get("substitute_fall"));
