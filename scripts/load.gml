...
sprite_change_offset("idle_hurt", 24, 78);
 sprite_change_offset("hurt", 26, 36);
sprite_change_offset("crouch", 19, 38);
sprite_change_offset("crawl", 19, 17);
...
sprite_change_offset("jump", 15, 45);
sprite_change_offset("doublejump", 44, 62);
...
sprite_change_offset("ntilt", 13, 42, true);
 sprite_change_offset("dtilt", 30, 20, true);
